...
class RealtimeStats:
    ...
    def process_event(self, event: PacketEvent):
        ...
        with self._lock:
            ...
            # FINAL VERDICT TRACKING - Track latest non-ACCEPT verdict per packet
            # Only track DROP/STOLEN/QUEUE verdicts (ACCEPT is skipped)
            if verdict_to_count and event.skb_addr:
                # Update latest non-ACCEPT verdict for this packet
                # DROP verdicts are final
